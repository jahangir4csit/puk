    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
                ...
                $terms = puk_filter_valid_terms( $terms );
            ...
            ?>
                <div class="product_categories">
                    <ul>
                        ...
                        <?php endforeach; ?>
                        <?php endif; ?>
                        <li><a href="<?php echo home_url('new-products'); ?>" class="is_new">New</a></li>
                    </ul>
                </div>
                ...
                <?php
                  ...
                  // Filter out placeholder terms (name '_')
                  $child_terms = puk_filter_valid_terms( $child_terms );
                  ?>
        ...
        // Filter terms (keep placeholder '_' terms but skip empty)
        $child_terms = puk_filter_valid_terms( $child_terms, false, false );
        ...
        if (!empty($child_terms)) :
            ...
            foreach ($child_terms as $child) :
                ...
                $pre_parent_term_id = $child->parent ;
                $pre_parent_term = get_term( $pre_parent_term_id, $child->taxonomy );

                // Build display name - hide '_' placeholder names
                $display_name = ($child->name === '_')
                    ? $pre_parent_term->name
                    : $pre_parent_term->name . ' ' . $child->name;

<div class="puk-post-card">
    <div class="puk-post-card__link">
        <div class="puk-post-card__body">
            ...
            <a href="#" class="puk-post-card__media video dark position-relative" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/od2.png');">
                ...
                <div class="puk-post-card__watermark">SECTOR</div>
            </a>
            <div class="puk-post-card__content">
                <h3 class="puk-post-card__title"><a href="#">TRON_ The flagship of 2020 collection.</a></h3>
                <article class="puk-post-card__excerpt">
                    <p>
                        During the webinar we will deepen the following aspects:
                        <ul>
                            <li>The idea of the designers:Nava+ Arosio studio;</li>
                            <li>The technical features and the available light distributions;</li>
                            <li>The lighting projects in which you can use it.</li>
                        </ul>
                    </p>
                </article>
                <a href="#" class="puk-post-card__arrow">
                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.0449 10.3453L17.5805 9.88006L13.6999 6.00291L12.7907 6.93425L15.5608 9.69994L2.58988 9.70572L2.59045 10.9987L15.5608 10.9929L12.7938 13.7611L13.7044 14.6916L17.5816 10.811L18.0449 10.3453Z"

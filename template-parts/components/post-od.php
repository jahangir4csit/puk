<div class="puk-post-card">
    <div class="puk-post-card__link" >
        <div class="puk-post-card__body">
            ...
            <a href="#" class="puk-post-card__media video position-relative" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/ondemand.jpg');">
                ...
                <div class="puk-post-card__watermark">TRON</div>
            </a>

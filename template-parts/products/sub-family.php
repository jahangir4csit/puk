                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="pf-grallary-grid">
                        ...
                        <div class="single-grid">
                            ...
                            <img src="<?php echo $subfamily_tech_draw; ?>" alt="Technical Drawing">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    foreach ($child_terms as $child) : 
                        ...
                        $index_number =  get_field('pf_subsub_fam_indx', 'products-family_' . $child->term_id);
                        $subsub_family_gallary =  get_field('pf_subsub_fam_tch_feturs', 'products-family_' . $child->term_id);
                                               ...
                                               $args = array(
                                                    ...
                                                    'tax_query'      => array(
                                                        array(
                                                            'taxonomy' => 'products-family',
                                                            'field'    => 'term_id',
                                                            'terms'    => $child->term_id,   // your selected taxonomy ID
                                                        )
                                                    ),
                                                    'orderby' => 'menu_order',
                                                    'order'   => 'ASC',
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="circle"
                                                                style="background: <?php echo $finish_color; ?>;"></span>
                                                            <?php echo $finish; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="<?php the_permalink(); ?>">
                                                                <img src="https://puk.dominiotest.ch/wp-content/uploads/2025/12/iconoir_arrow-right-circle.svg"
                                                                    alt="t7.png">
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="9">
                                                            <div class="td-inner-box">
                                                                ...
                                                                ?>
                                                                <a href="<?php echo $ltd_file; ?>" download
                                                                ...
                                                                <a href="<?php echo $instructions; ?>" download
                                                                    class="single-download">
                                                                ...
                                                                <a href="<?php echo $revit_file; ?>" download
                                                                    class="single-download">
                                            ...
                                            <div class="single-filter-accordion">
                                                ...
                                                <div class="filter-acc-content">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input filter_input " type="checkbox"

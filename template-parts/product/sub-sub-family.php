            ...
            <div class="row g-0">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">           
                    <div class="title-box-flex">
                        <div class="title-box">
                            <h1 aria-label="product title"> <?php echo esc_html($parent_term->name); ?> <?php echo esc_html($ancestor->name); ?>  </h1>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php 
                      ...
                      // ));
                        ...
                        $index_number = get_field('family_code', $sub_sub_term);
                        $subsub_family_gallary =  get_field('pf_subsub_fam_tch_feturs', 'product-family_' . $sub_sub_term->term_id);

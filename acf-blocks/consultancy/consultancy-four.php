...
<section id="<?php echo esc_attr( $block_id ); ?>" class="consultancy_page_block consultancy_page <?php echo esc_attr( $block_class ); ?> cnsltncy_pg_4">  
        ...
        <?php if ( $image_gallery ) : ?>
            <div class="cnsltncy_pg_img_grid"> 
                <?php foreach ( $image_gallery as $image ) : ?>
                    <div class="zoom_imggrid lightbox_img">
                        <img 

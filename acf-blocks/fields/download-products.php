...
acf_add_local_field_group( array(
    ...
    'fields' => array(
        ...
        array(
            'key' => 'field_download_products_enable_shadow',
            'label' => __( 'Enable Shadow', 'puk' ),
            'name' => 'enable_shadow',
            'type' => 'true_false',
            'instructions' => __( 'Enable shadow effect on product images', 'puk' ),
            'required' => 0,
            'default_value' => 1,
            'ui' => 1,
            'ui_on_text' => __( 'Yes', 'puk' ),
            'ui_off_text' => __( 'No', 'puk' ),
        ),
        array(

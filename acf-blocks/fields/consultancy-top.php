<?php
/**
 * ACF Field Group: Consultancy Top
 * 
 * @package Puk
 */
...
acf_add_local_field_group( array(
    'key' => 'group_consultancy_top',
    'title' => __( 'Consultancy Top Block', 'puk' ),
    'fields' => array(
        array(
            'key' => 'field_cons_top_main_heading',
...
service',
        ...
        array(
            'key' => 'field_cons_top_right_image',
            'label' => __( 'Top Right Image', 'puk' ),
            'name' => 'right_image',
            'type' => 'image',
        ...
        array(
            'key' => 'field_cons_top_section_1_heading',
        ...
        array(
            'key' => 'field_cons_top_section_1_content',
        ...
        array(
            'key' => 'field_cons_top_section_2_heading',
        ...
        array(
            'key' => 'field_cons_top_section_2_content',
    ...
    'hide_on_screen' => '',
    'active' => true,
    'description' => __( 'Fields for Consultancy Top block', 'puk' ),
) );

<?php
/**
 * Block Template: Integrated Consulting Service
 * 
 * @package Puk
 */
...
if ( $is_preview && empty( $main_heading ) ) {
    ...
    echo '<p>' . __( 'Integrated Consulting Service - Configure fields in the sidebar', 'puk' ) . '</p>';
    echo '</div>';
    return;
}
?>

<!-- Start:: consultancy integrate service  -->
<section id="<?php echo esc_attr( $block_id ); ?>" class="<?php echo esc_attr( $block_class ); ?> cnsltncy_pg_1">
...
<!-- END:: Consultancy integrate service  -->

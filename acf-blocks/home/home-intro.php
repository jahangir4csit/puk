...
$product_card_media_type = get_field('product_card_media_type') ?: 'image';
$product_card_image      = get_field('product_card_image');
$product_card_video      = get_field('product_card_video');
...
$project_card_media_type = get_field('project_card_media_type') ?: 'image';
$project_card_image      = get_field('project_card_image');
$project_card_video      = get_field('project_card_video');
...
$has_product_media = ( $product_card_media_type === 'image' && $product_card_image )
                  || ( $product_card_media_type === 'video' && $product_card_video );

$has_project_media = ( $project_card_media_type === 'image' && $project_card_image )
                  || ( $project_card_media_type === 'video' && $project_card_video );
?>
...
<section id="<?php echo esc_attr($block_id); ?>" class="intro-section <?php echo esc_attr($block_class); ?>">
    <div class="container">
        <div class="intro-grid">
            ...
            <!-- Left Column -->
            <div class="intro-grid-left gs-reveal-left <?php if ( $project_card_media_type == 'video' ){ echo 'gs-reveal-left-video' ; } ?>">
                ...
                <?php if ( $has_product_media ) : ?>
                    <div class="intro-product-card">
                        <div class="intro-card-media-wrap">
                            <?php if ( $product_card_media_type === 'video' && $product_card_video ) : ?>
                                <video
                                    src="<?php echo esc_url( $product_card_video['url'] ); ?>"
                                    class="gs-scale-video"
                                    autoplay
                                    muted
                                    loop
                                    playsinline>
                                </video>
                            <?php elseif ( $product_card_image ) : ?>
                                <img
                                    src="<?php echo esc_url( $product_card_image['url'] ); ?>"
            ...
            <!-- Right Column -->
            <div class="intro-grid-right gs-reveal-right <?php if ( $project_card_media_type == 'video' ){ echo 'gs-reveal-right-video' ; } ?>">

                <?php if ( $has_project_media ) : ?>
                    <div class="intro-project-card gs-scale-image-wrap">
                        <div class="intro-card-media-wrap overflow-hidden">
                            <?php if ( $project_card_media_type === 'video' && $project_card_video ) : ?>
                                <video
                                    src="<?php echo esc_url( $project_card_video['url'] ); ?>"
                                    class="gs-scale-video"
                                    autoplay
                                    muted
                                    loop
                            ...
                            <?php elseif ( $project_card_image ) : ?>
                                <img
                                    src="<?php echo esc_url( $project_card_image['url'] ); ?>"

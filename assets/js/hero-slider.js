...
(function() {
    ...
    function initHeroSlider() {
        ...
        heroSliders.forEach(function(sliderElement) {
            ...
            // Video Control - use slideChangeTransitionEnd for proper timing
            swiper.on('slideChangeTransitionEnd', function () {
                // Pause all videos (including cloned slides in loop mode)
                ...
                // Play video in active slide using Swiper's reference
            ...
            // Play first video on load using Swiper's reference

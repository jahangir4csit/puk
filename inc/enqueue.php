...
if (!function_exists('understrap_scripts')) {
    ...
    function understrap_scripts()
    {
        ...
        wp_enqueue_script('puk-accordion-filter', get_template_directory_uri() . '/assets/js/accordion-filter.js', array('jquery'), $theme_version, true);
        ...
        wp_add_inline_script('fancybox-js','Fancybox.bind("[data-fancybox=\"product-gallery\"]", {});');
        ...
        wp_enqueue_script('puk-load-more', get_template_directory_uri() . '/assets/js/load-more.js', array('jquery'), $theme_version, true);

<?php
/**
 * The template for displaying Project Category taxonomy archive
 *
 * @package Puk
 */
...
$description = term_description( $current_term->term_id, 'project_category' );

// Get projects in this category with pagination
                            ...
                            <ul>
                                ...
                                <?php if ( ! empty( $project_categories ) && ! is_wp_error( $project_categories ) ) : ?>
                                    <?php foreach ( $project_categories as $category ) :
                                        $is_active = ( $category->term_id === $current_term->term_id ) ? 'is_active' : '';
                                    ?>
                                        <li>
                                            <a class="<?php echo esc_attr( $is_active ); ?>" href="<?php echo esc_url( get_term_link( $category ) ); ?>">
                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                    <div id="puk-projects-container" class="prjct_pg_1_irow">
                        ...
                        <?php if ( $projects_query->have_posts() ) : ?>
                            ...
                            <?php endwhile; ?>
                        <?php else : ?>
                            <p><?php esc_html_e( 'No projects found in this category.', 'puk' ); ?></p>
                        <?php endif; ?>
